...
var style_2021_0 = function(feature, resolution){
    ...
    if (value >= 64.000000 && value <= 74.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 74.200000 && value <= 83.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 83.000000 && value <= 88.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 88.200000 && value <= 92.600000) {
            style = [ new ol.style.Style({
